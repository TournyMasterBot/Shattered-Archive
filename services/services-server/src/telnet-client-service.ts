...
export class TelnetClient extends EventEmitter implements ITelnetClient {
  ...
  // @ai-method: constructor — Initializes Telnet client with default properties and socket handlers.
  // @ai-hash: 3596d44c
  // ── END AI-METHOD ──
  ...
  // ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
  // @ai-method: Connect — Establishes a socket connection and resolves/rejects based on connection success or error.
  // @ai-hash: e37f04bc
  // ── END AI-METHOD ──
  ...
  // ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
  // @ai-method: Send — Sends a message through a socket with rate limiting and throttling.
  // @ai-hash: 3b98bf59
  // ── END AI-METHOD ──
  ...
  // ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
  // @ai-method: Disconnect — Stops pending timers, closes socket connections, and emits disconnect event.
  // @ai-hash: 42e9f2ae
  // ── END AI-METHOD ──
  ...
  // ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
  // @ai-method: attachBaseSocketHandlers — Attaches event handlers to process socket data, errors, and connection closure.
  // @ai-hash: e097ed07
  // ── END AI-METHOD ──
  ...
  // ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
  // @ai-method: processIncomingData — Processes incoming telnet data, handling subnegotiations, control codes, and buffering text until line breaks or timeouts.
  // @ai-hash: 1fbe8307
  // ── END AI-METHOD ──
  ...
  // ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
  // @ai-method: flushLine — Flushes buffered text as complete line with proper newline handling and emits both UI and processor events.
  // @ai-hash: 8a8a99e8
  // ── END AI-METHOD ──
