...
// @ai-method: normalizeBookPages — Normalizes book page data by filtering valid pages, ensuring minimum page 1, sorting by page number, and handling missing pages.
// @ai-hash: f49caf76
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: useLibrary — Manages and synchronizes library data including notes, books, and user notes for a given connection.
// @ai-hash: 0d5343a3
// ── END AI-METHOD ──
