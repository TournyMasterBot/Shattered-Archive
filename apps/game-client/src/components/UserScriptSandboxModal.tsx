...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: isObject — Checks if a value is a plain object, excluding null, arrays, and primitives.
// @ai-hash: 11d20441
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: isUserScriptLanguage — Checks if a value is a valid user script language identifier.
// @ai-hash: ff96b3e7
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: isUserScriptKind — Checks if a value matches one of the valid user script kinds.
// @ai-hash: 22968c9f
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: isValidUserScript — Validates if a value is a properly structured user script object with correct types and required properties.
// @ai-hash: b4892597
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: tryParseExportFile — Attempts to parse text input into a structured export file format, returning success or error details.
// @ai-hash: fb5c4164
// ── END AI-METHOD ──
  ...
  try {
    ...
    for (const it of (parsed as any).items) {
      ...
      items.push({
        ...
        selection:
          // ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
          // @ai-method: isObject — Checks if selection is an object with an ids array property.
          // @ai-hash: ae4b6cc5
          // ── END AI-METHOD ──
