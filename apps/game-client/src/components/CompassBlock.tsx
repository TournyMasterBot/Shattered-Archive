...
// @ai-method: CompassBlock — CompassBlock renders a directional navigation interface with interactive buttons for moving in cardinal and vertical directions.
// @ai-hash: 1a1ef7ae
// ── END AI-METHOD ──
