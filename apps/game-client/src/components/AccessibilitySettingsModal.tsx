...
// @ai-method: oneCharOr — Returns first character of trimmed input string or fallback if empty.
// @ai-hash: 3b73456e
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: clamp — Clamps a number between minimum and maximum values, returning the nearest valid bound if it exceeds the range.
// @ai-hash: 04673440
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: AccessibilitySettingsModal — Displays a modal for users to adjust vision and command input accessibility settings, with live preview and save/cancel functionality.
// @ai-hash: 7006669a
// ── END AI-METHOD ──
