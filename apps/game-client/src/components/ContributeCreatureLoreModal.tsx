...
// @ai-method: getIdentitySnapshot — Returns the current identity snapshot from the global window object or empty object.
// @ai-hash: 24d9e0e7
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: isBlankLine — Returns true if the input string is empty or contains only whitespace after trimming.
// @ai-hash: d6ffe505
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: applyBlankLineTailTrim — Removes trailing blank lines from an array of strings.
// @ai-hash: 72d41d34
// ── END AI-METHOD ──
...
export const ContributeCreatureLoreModal: React.FC<ContributeCreatureLoreModalProps> = ({
  ...
  // ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
  // @ai-method: onSubmit — Handles form submission for creature lore data with validation and API posting.
  // @ai-hash: c15599c3
  // ── END AI-METHOD ──
