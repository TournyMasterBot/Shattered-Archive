...
// @ai-method: loadSettings — Loads user interface settings from storage with default fallbacks.
// @ai-hash: 5b1a54c5
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: saveSettings — Saves settings to local storage ignoring any errors during the process.
// @ai-hash: c094273d
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: getDurationClass — Returns CSS class based on duration value with red for zero/negative, yellow for one, none otherwise.
// @ai-hash: 3973abe3
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: AffectsBlock — Displays and manages affect and gourd data with toggleable UI settings.
// @ai-hash: 3d2be23d
// ── END AI-METHOD ──
