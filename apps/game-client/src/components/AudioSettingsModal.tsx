...
// @ai-method: trimLines — Trims whitespace from each line and removes empty lines from input string.
// @ai-hash: 82dc0a60
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: newRule — Creates a new enabled rule with unique ID and empty pattern.
// @ai-hash: 08c201a8
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: ensureOsc — Ensures the input sound is of type 'osc' or throws an error.
// @ai-hash: a9e4db90
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: AudioSettingsModal — AudioSettingsModal renders a configurable audio settings dialog with tabs for general, inclusions, exclusions, and sounds, allowing users to enable/disable beeps, test sounds, and manage inclusion/exclusion rules.
// @ai-hash: 715e418f
// ── END AI-METHOD ──
