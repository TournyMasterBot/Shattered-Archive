...
// @ai-method: toInputString — Converts input value to string, returning empty string for nullish values.
// @ai-hash: dbe5c3a2
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: PluginConfigEditor — PluginConfigEditor renders configurable fields for a plugin's settings and syncs changes to storage.
// @ai-hash: 6816a231
// ── END AI-METHOD ──
