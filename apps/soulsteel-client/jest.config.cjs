/**
 * Local Jest config for the soulsteel-client package.
 *
 ...
 * `-client` dir, so no co-located test below it can match. Like scrum-poker-client, it
