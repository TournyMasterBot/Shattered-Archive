/**
 * Local Jest config for the soulsteel-server package.
 *
 ...
 * `-server` dir, so no co-located test below it can match. Like scrum-poker-server, it
