...
// @ai-method: isTargetAllowed — Checks if a target host and port combination is allowed based on configuration.
// @ai-hash: 1a12deef
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: getErrorMessage — Returns a string error message from various error input types.
// @ai-hash: 08068e0d
// ── END AI-METHOD ──
...
// ── AI-METHOD ── regenerated by annotate_methods — do not hand-edit
// @ai-method: setupGameWebSocketGateway — Mounts a WebSocket gateway to proxy MUD client connections through the server.
// @ai-hash: 8f1f4964
// ── END AI-METHOD ──
