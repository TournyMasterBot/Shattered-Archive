...
`;
    ...
    this.recommendedHelpFileChanges =
      "Include 'bugbear bite' as a keyword that can be used to search for this spell, bugbite isn't intuitive as the spell is listed as 'cure bugbear bite' in spells";
