...
given victim.
        `;
        this.manualDescription = "Meteo is the sole purview of the High Priest of a god. Only one high priest is allowed per god, and expect the road to last a decade or more in real life time.";
