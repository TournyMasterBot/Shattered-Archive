...
`;
        ...
        this.recommendedHelpFileChanges = "The skill is called staves, but the help file references staff. I would recommend swapping out 'staff' and 'staves' OR adding 'staves' as a keyword";
    ...
    public static GetInstance(): Staves {
        if (!Staves.instance) {
            Staves.instance = new Staves();
        }
        return Staves.instance;
    }
