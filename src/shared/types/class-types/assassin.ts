...
import CriticalShotFour from "@shared/types/ability-types/skills/CriticalShotFour";
import CriticalShotOne from "@shared/types/ability-types/skills/CriticalShotOne";
import CriticalShotThree from "@shared/types/ability-types/skills/CriticalShotThree";
import CriticalShotTwo from "@shared/types/ability-types/skills/CriticalShotTwo";
...
import QuickLoad from "@shared/types/ability-types/skills/QuickLoad";
...
See also - RECLASS`;
    ...
    public Get<T>(): T {
        return Assassin.GetInstance() as T;
    }
}
